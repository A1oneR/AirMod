...
public void OnPluginStart()
{
	...
	g_hDamage			= CreateConVar("l4d2_explawp_damage",			"500",		"Max damage of the explosion.", FCVAR_NOTIFY, true, 0.0, true, 1000.0);	// Need to clamp damage and radius or entity will bug
	...
	g_hDamageFriend		= CreateConVar("l4d2_explawp_damage_friendly",	"20",		"Max explosion damage caused to survivors.", FCVAR_NOTIFY, true, 0.0);
	g_hAllowScout		= CreateConVar("l4d2_explawp_allow_scout",		"0",		"If set to 1 Scout will cause explosions too.", FCVAR_NOTIFY, true, 0.0, true, 1.0);
