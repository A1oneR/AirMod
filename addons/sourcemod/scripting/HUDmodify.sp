...
public void OnPluginStart()
{
	...
	NCvar[CKillHud_FriendlyFire] = 		AutoExecConfig_CreateConVar("KillHud_FriendlyFire", "0", "[0=关|1=开]禁用/启用友伤统计显示", _, true, 0.0, true, 1.0);
	NCvar[CKillHud_KillSpecials] = 		AutoExecConfig_CreateConVar("KillHud_KillSpecials", "0", "[0=关|1=开]禁用/启用击杀特感统计显示", _, true, 0.0, true, 1.0);
	NCvar[CKillHud_KillTank] = 			AutoExecConfig_CreateConVar("KillHud_KillTank", "0", "[0=关|1=开]禁用/启用对坦克统计显示", _, true, 0.0, true, 1.0);
	NCvar[CKillHud_AllowBot] = 			AutoExecConfig_CreateConVar("KillHud_AllowBot", "0", "[0=关|1=开]禁用/启用Bot算进排名中", _, true, 0.0, true, 1.0);
	...
	NCvar[CKillHud_CStyleAllKillXY] = 	AutoExecConfig_CreateConVar("KillHud_CStyleAllKillXY", "0.24 0.9", "自定义Hud位置[其他][坐标最大值为1.0,对应分别为x轴与y轴]", FCVAR_NOTIFY);
